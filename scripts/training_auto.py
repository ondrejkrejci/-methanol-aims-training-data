...
# paths for the training and test file; has to end with xyz, but extxyz format
cwd = os.getcwd()
training_data_path = os.path.join(cwd, "training_data.xyz")
test_file_path = os.path.join(cwd, "test_data.xyz")
...
def train_models(num_models, seeds, training_data_path, test_file_path):
...
train_models(number_of_models, seeds_of_models, training_data_path, test_file_path)
